    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(blank=True, upload_to=user.models.user_directory_path)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('alert_new_subscribe', models.BooleanField()),
                ('alert_new_item', models.BooleanField()),
                ('alert_suggested_boards', models.BooleanField()),
